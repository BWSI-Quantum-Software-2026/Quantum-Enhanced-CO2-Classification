...
def qnn_temperature():
    ...
    X_train, Y_train = X[:split_index], Ytemp[:split_index] # training inputs and targets
    X_val, Y_val = X[split_index:], Ytemp[split_index:] # validation inputs and targets
    ...
    for epoch in range(epochs):
        ...
        print(f"Temperature, Epoch {epoch}, training loss = {loss_train(w):.6f}, validation loss = {loss_val(w):.6f}") # finds training and validation loss and prints both to 6 decimals
