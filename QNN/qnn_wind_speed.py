...
def qnn_wind_speed():
    ...
    X_train, Y_train = X[:split_index], Ywspd[:split_index] # training inputs and targets
    X_val, Y_val = X[split_index:], Ywspd[split_index:] # validation inputs and targets
